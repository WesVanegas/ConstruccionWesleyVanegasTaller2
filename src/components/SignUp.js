...
export const SignUp = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            cc: Yup.number().min(1000000, 'Should be 7 characters min').required('Required'),
            username: Yup.string().min(2, 'Should be 2 characters min').required('Required'),
        ...
        <div className='flex justify-center mt-10'>
            <div className='w-full max-w-3xl'>
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className='mb-4'>
                        <label className='block text-gray-700 text-sm font-bold mb-2' htmlFor='cc'>Id number (CC)</label>
                        <input
                            className='shadow appearance-none border rounded w-full py-2 text-gray-700 leading-tight focus:outline-none'
                            id='cc'
                            type='number'
